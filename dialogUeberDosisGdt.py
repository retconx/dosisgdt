...
class UeberDosisGdt(QDialog):
    def __init__(self):
        ...
        labelBeschreibung = QLabel("<span style='color:rgb(0,0,200);font-weight:bold'>Programmbeschreibung:</span><br>DosisGDT ist eine eigenständig plattformunabhängig lauffähige Software zur Erstellung eines Dosierungsplans via GDT-Schnittstelle in ein beliebiges Praxisverwaltungssystem.")
        ...
        labelHilfe = QLabel("<span style='color:rgb(0,0,200);font-weight:bold'>Hilfe:</span><br><a href='http://www.github.com/retconx/dosisgdt/wiki'>DosisGDT Wiki</a>")
