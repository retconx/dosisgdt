...
class EinstellungenGdt(QDialog):
    def __init__(self, configPath):
        ...
        self.idDosisGdt = configIni["GDT"]["iddosisgdt"]
        self.idPraxisEdv = configIni["GDT"]["idpraxisedv"]
        self.kuerzeltDosisGdt = configIni["GDT"]["kuerzeldosisgdt"]
        ...
        labelDosisGdt = QLabel("DosisGDT:")
        labelDosisGdt.setStyleSheet("font-weight:normal")
        ...
        self.lineEditDosisGdtId = QLineEdit(self.idDosisGdt)
        self.lineEditDosisGdtId.setStyleSheet("font-weight:normal")
        self.lineEditDosisGdtId.setEnabled(False)
        self.lineEditPraxisEdvId = QLineEdit(self.idPraxisEdv)
        self.lineEditPraxisEdvId.setStyleSheet("font-weight:normal")
        groupboxLayoutG.addWidget(labelDosisGdt, 0, 0)
        groupboxLayoutG.addWidget(self.lineEditDosisGdtId, 0, 1)
        ...
        labelDosisGdtKuerzel = QLabel("DosisGDT:")
        labelDosisGdtKuerzel.setStyleSheet("font-weight:normal")
        labelPraxisEdvKuerzel = QLabel("Praxis-EDV:")
        labelPraxisEdvKuerzel.setStyleSheet("font-weight:normal")
        self.lineEditDosisGdtKuerzel = QLineEdit(self.kuerzeltDosisGdt)
        self.lineEditDosisGdtKuerzel.textChanged.connect(self.kuerzelGeaendert) # type:ignore
        self.lineEditDosisGdtKuerzel.setStyleSheet("font-weight:normal")
        self.lineEditDosisGdtKuerzel.setEnabled(False)
        ...
        self.labelImportDateiname = QLabel("Import-Dateiname: " + self.lineEditDosisGdtKuerzel.text() + self.lineEditPraxisEdvKuerzel.text() + ".gdt")
        self.labelImportDateiname.setStyleSheet("font-weight:normal")
        self.labelExportDateiname = QLabel("Export-Dateiname: " + self.lineEditPraxisEdvKuerzel.text() + self.lineEditDosisGdtKuerzel.text() + ".gdt")
        self.labelExportDateiname.setStyleSheet("font-weight:normal")
        groupboxLayoutG.addWidget(labelDosisGdtKuerzel, 0, 0)
        groupboxLayoutG.addWidget(self.lineEditDosisGdtKuerzel, 0, 1)
        ...
        self.lineEditDosisGdtId.setFocus()
        self.lineEditDosisGdtId.selectAll()

    def kuerzelGeaendert(self):
        kuerzelDosisGdt = self.lineEditDosisGdtKuerzel.text()
        kuerzelPraxisEdv = self.lineEditPraxisEdvKuerzel.text()
        self.labelImportDateiname.setText("Import-Dateiname: " + kuerzelDosisGdt + kuerzelPraxisEdv + ".gdt")
        self.labelExportDateiname.setText("Export-Dateiname: " + kuerzelPraxisEdv + kuerzelDosisGdt + ".gdt")
